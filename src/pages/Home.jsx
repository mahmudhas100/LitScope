      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="pt-20 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="text-center">
            <h1 className="text-4xl tracking-tight font-extrabold text-ink font-serif sm:text-5xl md:text-6xl">
              <span className="block">Welcome to</span>
              <span className="block text-primary-600">LitScope</span>
            </h1>
            <p className="mt-3 max-w-md mx-auto text-base text-ink/70 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            ...
            <div className="mt-10 flex gap-4 justify-center">
              ...
              <button
                ...
                className="px-8 py-3 rounded-xl border-2 border-primary-600 text-white bg-primary-600 font-medium hover:bg-primary-700 transition duration-150 ease-in-out transform hover:scale-105 shadow-lg"
              >
                Join a Club
              </button>
            </div>
          ...
          <div className="mt-32 grid grid-cols-1 gap-8 md:grid-cols-3">
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-stone-100 hover:shadow-md transition-shadow duration-300">
              <div className="h-14 w-14 bg-primary-100 rounded-xl flex items-center justify-center mb-6 text-primary-600">
                <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                </svg>
              </div>
              <h3 className="text-xl font-bold text-ink font-serif mb-3">Create Book Clubs</h3>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-stone-100 hover:shadow-md transition-shadow duration-300">
              ...
              <h3 className="text-xl font-bold text-ink font-serif mb-3">Live Discussions</h3>
              <p className="text-ink/70 leading-relaxed">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-stone-100 hover:shadow-md transition-shadow duration-300">
              ...
              <h3 className="text-xl font-bold text-ink font-serif mb-3">Reading Progress</h3>
              <p className="text-ink/70 leading-relaxed">
          ...
          <div className="mt-20 text-center">
            ...
            <button
              ...
              className="mt-5 px-8 py-3 bg-primary-600 text-white font-semibold rounded-lg hover:bg-primary-700 transition duration-150 ease-in-out transform hover:scale-105 shadow-lg"
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-ink font-serif">LitScope</h3>
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-ink font-serif">Quick Links</h3>
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-ink font-serif">Connect</h3>
              <ul className="space-y-2 text-sm text-ink/60">
                <li>
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-ink font-serif">Contact Us</h3>
              <ul className="space-y-2 text-sm text-ink/60">
